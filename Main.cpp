...
AMain::AMain()
{
	...
	//Create Camera Boom (Pulls towards player if there is collision)
	CameraBoom = CreateDefaultSubobject<USpringArmComponent>(TEXT("CameraBoom"));
	CameraBoom->SetupAttachment(GetRootComponent());
	CameraBoom->TargetArmLength = 600.f; //Camera follows at this distance
	CameraBoom->bUsePawnControlRotation = true; //Rotating is based on controller
	...
	//Attach camera to end of boom and let the boom adjust to match the controller orientation
	...
	//Stops rotating char when controller rotates. Just affects camera
